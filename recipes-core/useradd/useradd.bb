...
# user1 and user2:
USERADD_PARAM_${PN} = "-u 800 -d /home/user1 -r -s /bin/bash user1; -u 800 -d /home/user2 -r -s /bin/bash user2"

# user3 will be managed in the useradd-example-user3 pacakge:
# As an example, we use the -P option to set clear text password for user3
USERADD_PARAM_${PN}-user3 = "-u 800 -d /home/user3 -r -s /bin/bash -P 'user3' user3"
